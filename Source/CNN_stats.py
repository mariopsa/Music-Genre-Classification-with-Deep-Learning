...
results_file = "json_files/cnn_results.json"
...
plt.title("Test Accuracy Distribution (CNN)")
plt.ylabel("Accuracy")
plt.show()

plt.figure(figsize=(8, 6))
plt.hist(test_accuracies, bins=10, edgecolor='k', alpha=0.7)
plt.title("Test Accuracy Histogram (CNN)")
plt.xlabel("Accuracy")
...
plt.title("Test Loss Distribution (CNN)")
plt.ylabel("Loss")
plt.show()

plt.figure(figsize=(8, 6))
plt.hist(test_errors, bins=10, edgecolor='k', alpha=0.7)
plt.title("Test Loss Histogram (CNN)")
plt.xlabel("Loss")
plt.ylabel("Frequency")
plt.show()
...
plt.title("Traditional learning curve (CNN)")
